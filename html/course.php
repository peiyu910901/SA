          ...
          >
            ...
            <div class="content-wrapper">
              ...
              <main class="container"><br>
                ...
                <div class="row">
                          <div class ="mb-2 col-md-8" style="margin-left:30px">
                            ...
                            <option disabled selected value="">請選擇修課學期</option>
                            ...
                            <button type ="submit" class="btn btn-outline-primary">搜尋</button></form>
                          </div></div>
                          <div class="row">
               
              <?php
               if(isset($semester)){
                $comment_sql="select * from comment where comment_semester='$semester' and course_id='$course_id'"; }
                else{
                $comment_sql="select * from comment where course_id='$course_id'";
                }
                $comment_rs=mysqli_query($link,$comment_sql);
                ...
                ?>
             <br>
            <div class="card col-5" style="margin-left:45px;margin-right:45px;margin-bottom:45px;margin-top:10px;">
                    ...
                    <div class="col-md-12" >
                        <div class="white-block mb-10">
                          ...
                          <tr white-space="nowrap">
                            <td>修課學期 - <?php echo $comment_record[6]?></td>
                          </tr>
                          <tr white-space="nowrap">
