        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text"><h5>課程分類</h5></span>
            </li>
                      ...
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h3 class="card-title text-primary">
                            <span class="fw-bold">歡迎使用<br/>輔大課程評價系統</span> </h3>
                          <p class="mb-4">
                           希望同學可以<font color="red">註冊帳號</font>並且踴躍填寫課程評價!<br/>
                           可以使用左邊的分類或上方的關鍵字查詢想看的課程評價<br/>
                           也可點選下方按鈕瀏覽所有評價<br/>
                           登入系統後即可使用收藏&檢舉功能歐!
                          </p>

                          <a href="allcomment.php" class="btn btn-outline-primary">所有評價</a>

                          <?php if(isset($_SESSION["Ismanager"])){?>
                          <a href="agreecomment.php" class="btn btn-outline-primary">新增評價</a>
                          <?php }
                          else{ ?> <a href="alertlogin.php" class="btn btn-outline-primary">新增評價</a>
                           <?php }?>
