                    ...
                    <div class="card">
                      ...
                      <section>
                        ...
                        <?php
                          ...
                          $sql="select * from collect where collect_email='$email'";
                        ...
                        ?>
                          ...
                          <td><?php echo $record[2];?></td>
                            ...
                            <td><a href = "course.php?course_id=<?php echo $record[1];?>"><?php echo $record[4];?></td>
                            <td><?php echo $record[5];?></td>
                            <td><?php echo $record[6];?></td>
                            <td><a href="collectdelete.php?collect_id=<?php echo $record[0];?>">
                            <img
